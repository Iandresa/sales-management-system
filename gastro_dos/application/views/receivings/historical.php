...
<div id="title_bar">
    <div id="title" class="float_left"><?php echo $this->lang->line('recvs_historical'); ?></div>
</div>
...
{?>
    ...
    <div id="search_filter_section" style="display: <?php echo isset($search_section_state)?  ( ($search_section_state)? 'block' : 'none') : 'none';?>;background-color:#EEEEEE;">
        <?php echo form_open("receivings/select_receiving",array('id'=>'select_receiving_form')); ?>
        <?php echo form_label($this->lang->line('recvs_id').' '.':', 'id_receiving');?>
        <?php echo form_input(array('name'=>'receiving','id'=>'receiving','size'=>'12','value'=>$this->lang->line('recvs_start_typing_receiving_id')));?>
        ...
        <span style="float:right;"><?php echo anchor("receivings/show_all","<div class='small_button'><span>".$this->lang->line('recvs_show_all')."</span></div>",
	...
	<?php echo form_label($this->lang->line('sales_mode').' '.':', 'kind_mode');?>
...
$(document).ready(function()
{
    ...
    $("#receiving").autocomplete('<?php echo site_url("receivings/receiving_search"); ?>',
    {
    	minChars:0,
    	delay:10,
    	max:100,
    ...
    $("#receiving").result(function()
    {
	$("#select_receiving_form").submit();
    });

    $('#receiving').blur(function()
    {
    	$(this).attr('value',"<?php echo $this->lang->line('recvs_start_typing_receiving_id'); ?>");
    });
});
</script>