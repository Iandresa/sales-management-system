...
$(document).ready(function(){
 ...
 <div id='print'> 
     ...
     <div id="receipt_header" style="margin-left:40%; margin-right: 30%" >
		...
		<div id="sale_receipt"><?php echo $this->lang->line('common_list_of') . ' ' . $this->lang->line('cafeteria_list_deliveries_finished'); ?></div>
...
<div id="<?php echo scroll($cantidad_deliveries) ?>">
	...
	?>
	 ...
	 <tr>
                    ...
                    <th style="width:20%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $delivery->first_name.' '.$delivery->last_name?></th>
                    <th style="width:20%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $delivery->sale_time ?></th>
                    <th style="width:25%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $delivery->payment_type ?></th>
                    <th style="width:20%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $delivery->sale_timeToFinish ?></th>
                ...
                <tr>
                    <td align="center" colspan="5" >
                        ...
                        <tbody>
			  <?php
                          foreach( $finished_items->result() AS $detalle ){
                          ?>     
