...
if ($cantidad_clientes > 0) {
    ...
    <div id="<?php echo show_scroll($cantidad_clientes) ?>">
        <div id="CollapsiblePanelGroup1" class="CollapsiblePanelGroup">
            ...
            ?>
            <?php
                $detalles = $this->Delivery->get_details_from_unsettled_sale($venta->sale_id);
                ...
                <div class="CollapsiblePanel">
                    ...
                    <div class="CollapsiblePanelContent" >
                        <div id="address" align="center">
                            <?php echo form_label($this->lang->line('common_address_1') . ':', 'address_1'); ?> <?php echo ($venta->address_1) ? $venta->address_1 : '' ?> &nbsp;&nbsp; <?php echo form_label($this->lang->line('common_city') . ':', 'city'); ?> <?php echo ($venta->city) ? $venta->city : '' ?><br />
                            <?php echo form_label($this->lang->line('common_address_2') . ':', 'address_2'); ?> <?php echo ($venta->address_2) ? $venta->address_2 : '' ?> &nbsp;&nbsp; <?php echo form_label($this->lang->line('common_state') . ':', 'state'); ?> <?php echo ($venta->state) ? $venta->state : '' ?>
                        </div>
                        <div id="contentTable">
                            <?php echo form_open("deliveries/finish_item_sale/$venta->sale_id", array('id' => 'finish_item_sale_form')); ?>
                                        ...
                                        ?> </td>
                                            <td>
                                                <?php
                                                    if($language=="english")
                                                    {
                                                        echo anchor("deliveries/cancel_item_sale/$venta->sale_id/$detalle->item_id",
    ...
    ?>
    <div id="cartel_sin_ventas_pendientes">
        <?php echo $this->lang->line('cafeteria_delivery_empty'); ?>
    </div>	
    <?php
}
?>
