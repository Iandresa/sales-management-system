...
<div id="receipt_wrapper">
    <div id='print'>
        <img width="50px" style="margin-left: 435px;" src="<?php echo base_url().'/images/logotipo/'.$this->lang->line('login_out'); ?>.png"
                 border="0"/>
...
<div id="vinc1">
<?php
    echo anchor("sales/go_to_sales", "<div class='sb1' style='float:right;'><span>".$this->lang->line('sales_go_to_sales')."</span></div>", array('title'=>$this->lang->line('sales_go_to_sales')));
?>
