...
class Customers extends Person_controller
{
	...
	{	
		...
		$data['manage_table']=get_people_manage_table($this->Customer->get_all_VIP_column(),$this);//ECP V_2 punto 3.8.1
	...
	*/
	function search()
	{
		...
		$data_rows=get_people_manage_table_data_rows($this->Customer->search_VIP_column($search),$this);//ECP V_2 punto 3.8.1
		echo $data_rows;
	}
	...
	*/
	function save($customer_id=-1)
	{
		...
		'taxable'=>$this->input->post('taxable')=='' ? 0:1,
                'VIP_limit'=>$this->input->post('VIP_limit')//ECP
		);
