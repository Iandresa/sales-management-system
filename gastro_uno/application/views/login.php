...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
<title>Gastro<?php echo $this->lang->line('login_login'); ?></title>
...
<?php echo validation_errors(); ?>
	...
	<div id="new_button">
		<a title="<?php echo $this->lang->line('login_register'); ?>" href="<?php echo site_url('register');?>"><?php echo $this->lang->line('login_register'); ?></a>
	</div>
</div>
<?php echo form_close(); ?>
</body>
