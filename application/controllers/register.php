...
class Register extends Controller 
{
	...
	{ 
		...
		'subsidary'=>$this->input->post('subsidary'),
                ...
                'timezone'=> $this->input->post('timezone'),//new HL
		...
		$register = array(
               array(
                     'field'   => 'first_name', 
                     'label'   => $this->lang->line('common_first_name'), 
                     'rules'   => 'required'
                  ),
                    array(
                     'field'   => 'last_name', 
                     'label'   => $this->lang->line('common_last_name'), 
                     'rules'   => 'required'
                  ),
               array(
                     'field'   => 'username', 
               ...
               array(
                    ...
                    ,
               array(
                     'field'   => 'default_tax_1_rate',
                     'label'   => $this->lang->line('config_default_tax_rate_1'),
               ...
               array(
                     'field'   => 'address_1', 
                     'label'   => $this->lang->line('common_address1_required'), 
                     'rules'   => 'required'
                  ),
               array(
                     'field'   => 'city', 
                     'label'   => $this->lang->line('common_city_required'), 
                     'rules'   => 'required'
                  ),
               array(
                     'field'   => 'state', 
                     'label'   => $this->lang->line('common_state_required'), 
                     'rules'   => 'required'
                  ),
               array(
                     'field'   => 'country', 
               ...
               array(
                     'field'   => 'currency', 
                     'label'   => $this->lang->line('currency_required_field'), 
                     'rules'   => 'required'
                  )
		...
		else
		{
			$this->Employee->saveRegister($data);
                        ...
                        $this->tasklib->Sent_Letter_To_Person($stdletter_id_name, $email, $language, $client_name,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
//                'enterprise_id'=>'',
            ...
            $lang = $this->input->post('language');
            $timezone = $this->input->post('timezone'); //new HL
            $this->db->insert('adviser_lang', array('person_id'=> $insert_id, 'language'=>$lang, 'timezone'=>$timezone));//change HL
...
//            }
    ...
    function new_adviser_check()
    {
        ...
        if($address == "")
        {
            $message[] = $this->lang->line('common_address1_required');
        }
        if($city == "")
        {
            $message[] = $this->lang->line('common_city_required');
        }
        if($state == "")
        {
            $message[] = $this->lang->line('common_state_required');
        }
        //
        //$question
        if($question == "")
