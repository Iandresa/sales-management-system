...
class Advisers extends Secure_area {
    ...
    function view($employee_id=-1) {
        ...
        $data['lang'] = $lang;
        //NEW
        $timezone = $this->Employee->get_adviser_timezone($employee_id);
    ...
    function save($employee_id=-1)
	{
		...
		elseif($this->Employee->save($person_data,$employee_data,$permission_data,$employee_id))
		{
                        ...
                        $this->db->update('adviser_lang', array('language'=> $this->input->post('language'), 'timezone'=> $this->input->post('timezone')));//change HL
