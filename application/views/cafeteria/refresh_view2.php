...
<div id="<?php echo scroll($cantidad_orders) ?>">
	...
	<div class="CollapsiblePanel">
		<div class="CollapsiblePanelTab" tabindex="0"><?php echo $num.' - '.$order->first_name.' '.$order->last_name?> &nbsp;&nbsp; <span class="fecha"> <?php echo $order->sale_time?> </span> 
                    <div id="r">
                        <span class="cant_a_pagar"><?php echo $this->lang->line('cafeteria_payment_amount')?></span> 
                        <span class="negro"><?php echo $order->payment_type ?></span>
                    </div>
                    <div style="text-align: right;">
                        <span class="cant_a_pagar"><?php echo $this->lang->line('cafeteria_date_to_dispatch').': '?></span>
                        <span class="negro"> <?php echo $order->sale_timeToFinish ?> </span>
                    </div>
                </div>
