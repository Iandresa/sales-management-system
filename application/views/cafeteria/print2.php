...
<div id='print'>
     ...
     <div id="receipt_header" style="margin-left:40%; margin-right: 30%" >
		...
		<div id="sale_receipt"><?php echo $this->lang->line('common_list_of') . ' ' . $this->lang->line('cafeteria_list_orders_finished'); ?></div>
	...
	?>
        ...
        ?>
                <tr>
                    ...
                    <th style="width:20%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $order->first_name.' '.$order->last_name?></th>
                    <th style="width:20%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $order->sale_time ?></th>
                    <th style="width:25%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $order->payment_type ?></th>
                    <th style="width:20%;text-align:center;text-align:center; border: black solid 1px; color: black; font-family: sans-serif; font-size:12px;"><?php echo $order->sale_timeToFinish ?></th>
