...
<div id="title_bar">
	...
	<div id="new_button">
		...
		?>
                ...
                <?php echo anchor("suppliers/view/-1/width:$form_width",
		"<div class='big_button' style='float: left;'><span>".$this->lang->line('suppliers_new')."</span></div>",
		array('class'=>'thickbox none','title'=>$this->lang->line('suppliers_new')));
		?>
            
		<?php echo anchor("$controller_name/excel_import/width:$form_width",
		"<div class='big_button' style='float: left;'><span>".$this->lang->line('items_excel_import')."</span></div>",
		array('class'=>'thickbox none','title'=>$this->lang->line('items_import_items_from_excel')));
		?>
		
		<?php echo anchor("$controller_name/excel_help/width:360",
		"<div class='help' style='float: left;'></div>",
		array('class'=>'thickbox none','title'=>$this->lang->line('items_import_items_from_excel_help')));
		?>
	</div>
</div>
