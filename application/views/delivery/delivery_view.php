...
<div id="title_bar" style="width: 100%">
    <div id="title" style="width: 100%" class="float_left"><?php echo $this->lang->line('common_list_of') . ' ' . $this->lang->line('module_' . $controller_name); ?>
        <?php 
			echo anchor("deliveries/view_report",
...
{  
    ...
    function callMeOften()
    {
        $.ajax({
            method: 'post',
            url : '<?php echo site_url(); ?>/deliveries/update_div',
            dataType : 'text',
    ...
    function callMeOften2()
    {
        $.ajax({
            method: 'post',
            url : '<?php echo site_url(); ?>/deliveries/update_div2',
            dataType : 'text',
            success: function (text) { 
                //alert(text);
                $('#updateMe2').html(text); 
...
<div style="border:solid 1px #A7A7A7;padding:10px">
    <div id="updateMe">
        <?php
        $this->load->view('delivery/refresh_view');
        ?>
    </div>    
</div>
...
<div id="title_bar" style="width: 100%">
	<div id="title" style="width: 100%" class="float_left"><?php echo $this->lang->line('common_list_of').' '.$this->lang->line('cafeteria_list_deliveries_finished'); ?>
           <?php 
                            echo anchor("deliveries/view_report2",
                            "<div class='small_button2' style='float:right;margin-top:5px;'><span>".$this->lang->line('cafeteria_imprimir')."</span></div>",
                            array('class'=>'thickbox none','title'=>$this->lang->line('common_list_of') . ' ' . $this->lang->line('cafeteria_list_deliveries_finished')));
...
<div id="updateMe2">
    <?php
    $this->load->view('delivery/refresh_view2');
    ?>
</div> 
