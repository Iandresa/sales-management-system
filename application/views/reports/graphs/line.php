...
$hol = new hollow_dot();
//$hol->size(3)->halo_size(1)->tooltip('dddddddddddddd');//ECP conel nuevo open-flash-chart cambió la forma de configurar el tooltip

$line = new line();
$line->set_default_dot_style($hol); 
$line->set_values($line_data);

$line->set_tooltip('#x_label#<br>#val#');//ECP
