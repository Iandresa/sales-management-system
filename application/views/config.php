...
<?php  echo $this->session->userdata('cur_info'); ?>
...
{	
<?php if(isset($success)&&$success==1)echo "set_feedbackConfig('".$this->lang->line('config_saved_successfully')."',false)";?>;
                ...
                submitHandler:function(form)
		{
			...
			success:function(response)
			{
				if(response.success)
				{
					...
					set_feedbackConfig(response.message,true);	

					//setTimeOut("alert('hola');", 100);no me funciona
					//aki
					//location.reload(1);
					// setTimeout("location.href = "<?php echo base_url().'index.php/home' ?>"",80000);	
					location.href = "<?php echo base_url().'index.php/config/index/1' ?>";
     		...
     		phone: 
                {
                    ...
                    number:"<?php echo $this->lang->line('config_phone_number'); ?>"
                },
                zip: 
                { 
