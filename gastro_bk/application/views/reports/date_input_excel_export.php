...
<?php 
	...
	{
		case 1:
			echo $this->lang->line('reports_sales_summary_report');
		break;
		case 2:
			echo $this->lang->line('reports_categories_summary_report');
		break;
		case 3:
			echo $this->lang->line('reports_customers_summary_report');
		break;
		case 4:
			echo $this->lang->line('reports_suppliers_summary_report');
		break;
		case 5:
			echo $this->lang->line('reports_items_summary_report');
		break;
		case 6:
			echo $this->lang->line('reports_employees_summary_report');
		break;
		case 7:
			echo $this->lang->line('reports_taxes_summary_report');
		break;
		case 8:
			echo $this->lang->line('reports_discounts_summary_report');
		break;
		case 9:
			echo $this->lang->line('reports_payments_summary_report');
		break;
	} 
?>
</div>
