...
class Sales extends Secure_area
{
	...
	function complete($un_seted=false,$delivery=false,$complete=true)
	{                     
		...
		$data['sale_id']='POS '.$this->Sale->save($data['cart'], $customer_id,$employee_id,$comment,$data['payments'],false,$un_seted,$delivery);
