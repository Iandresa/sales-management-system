    ...
    */
    ...
    init: function( target, options ) {
        ...
        this._options = {
            ...
            pause_on_interaction: false, // 1.9.96 Al dar next sigue caminando aleatoriamente
            popup_links: false,
            preload: 2,
            queue: true,
            show: 0,
            show_info: true, //mostrar el titulo si tiene
            show_counter: true,
            show_imagenav: true,
            thumb_crop: true,
            ...
            thumb_margin: 7,
            thumb_quality: 'auto',
            thumbnails: true, //muestra los cuadritos de abajo
            transition: 'fade',
            transition_initial: undef,
            transition_speed: 1000, //velocidad en que van pasando las imagenes
            width: 'auto'
        };
