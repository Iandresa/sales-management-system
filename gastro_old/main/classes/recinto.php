...
class recinto {
    ...
    function nuevoRecinto($rut,$nombre,$direccion,$ciudad,$estado,$anioInicio,$correo,$telefono,$pais,$fechaCreacion,$cap)
    {
        $query = "INSERT INTO Recinto(rut,nombre,direccion,ciudad,estado,anioInicio,correo,telefono,pais,fechaCreacion,capital) VALUES('".$rut."','".$nombre."','".$direccion."','".$ciudad."','".$estado."',".$anioInicio.",'".$correo."',".$telefono.",'".$pais."',".$fechaCreacion.",".$cap.");";
