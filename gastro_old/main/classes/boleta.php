...
class boleta {
   ...
   protected $db;
    ...
    function nuevaBoleta($idRec,$idPed,$idMesa,$impuesto,$descuento,$observaciones,$fecha,$estado,$totalNeto)
    {
        $query = "INSERT INTO Boleta(idRecinto,idPedido,idMesa,impuesto,descuento,observaciones,fechaEmision,estado,total) VALUES(".$idRec.",".$idPed.",".$idMesa.",".$impuesto.",".$descuento.",'".$observaciones."',".$fecha.",'Emitida',".$totalNeto.");";
